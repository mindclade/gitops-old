...
class ReleaseMetadataContractTest(unittest.TestCase):
    ...
    def test_empty_v4_schema_migration_is_trusted(self) -> None:
        ...
        # The promoted v4 validator must apply full semantics to a v4 record rather
        # than waving it through: producer_evidence is v4-only, so naming it proves
        # the promoted checks ran.
        self.assertIn("producer_evidence", result.stderr)
