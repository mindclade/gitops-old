...
CONTRACT = json.loads(
    ...
    '"applications","deployments","projects","projects/argocd-administration.yaml","policy","qualification","qualification/schemas/qualification-request-v1.schema.json","qualification/schemas/qualification-report-v2.schema.json","qualification/workstation-image-readiness.yaml","scripts/audit-production-estate.py","scripts/deterministic-qualification-archive.py","scripts/production_qualification.py","scripts/production_eligibility.py","scripts/validate-workstation-image-readiness.py","tests/test_workstation_image_readiness.py",".github/workflows/production-qualification-evidence.yml",".github/workflows/dr-evidence.yml","overlays/production.yaml",'
